...
from US_Visa_Pred.data_access.convertor import USdata
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        try:
            ...
            usvisa_data = USdata()
            dataframe = usvisa_data.extract_collection_as_dataframe(collection_name= self.data_ingestion_config.collection_name)
